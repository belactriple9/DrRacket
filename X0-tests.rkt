...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname X0-tests) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f () #f)))
...
(define all-tests
  `{("7" 7 7)
   ...
   ; YOU-MUST-CREATE-SOME-TESTS-FOR-IfPos
